...
const char* ssid = "WIFI-SSID"; // your network AP SSID
const char* password = "WIFI-PASSWORD"; // your network AP password
...
const int channel = 4; // channel to use - these are 1 lower than normal (0 = 1)
